...
for i = 2:N
    ...
    tmp1 = [x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar] - Lx1*f_bar;
    tmp2 = [x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar;x_bar] - Lx2*f_bar;
    ...
    figure(1);
    plot( i - 1: i+N - 2, squeeze(plan_trajectory(1,1,1:N)));
    hold on
    figure(2);
    plot( i - 1:i+N - 2, squeeze(plan_trajectory(2,1,1:N)));
    hold on
...
figure(1);
plot(1:N, squeeze(x(1,1,1:N)));
figure(2);
plot(1:N, squeeze(x(2,1,1:N)));
figure(1);
plot(0:20, [xo(1); squeeze(r(1,1,1:20))]);
figure(2);
plot(0:20, [xo(2); squeeze(r(2,1,1:20))]);
%% problem 2.1
clear all
close all
% w = rand(1,10);
...
figure(1);
title('first state')
plot(1:N, squeeze(x_star(1,1,1:N)));
hold on;
plot(1:N, squeeze(x_noisy(1,1,1:N)));
figure(2);
title('second state')
plot(1:N, squeeze(x_star(2,1,1:N)));
hold on;
plot(1:N,squeeze(x_noisy(2,1,1:N)));
...
figure(3);
title('errors')
plot(1:N, squeeze(error(1,1,1:N)));
hold on
plot(1:N, squeeze(error(2,1,1:N)));
